...
const on = function(){
    for (var i = 0; i < len; i++){
        ...
        circle[i].computedStyleMap.animationPlayState = 'running';
        circle[i].computedStyleMap.webkitAnimationPlayState = 'running';
    }
}
...
function convert(){
    var speed = document.getElementById('quantity').ariaValueMax;
    for (var i = 0; i < len; i++){
